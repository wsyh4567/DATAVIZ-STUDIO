                ...
                **{"aria-label": "数据预览控制"},
                children=[
                    ...
                    html.Div(
                        ...
                        **{"aria-label": "数据预览模式选择"},
                        children=[
                            html.Button("前 N 行", id="btn-view-head", className="dvs-btn dvs-btn--sm dvs-btn--primary", **{"aria-label": "显示前N行数据"}),
                            html.Button("中间 N 行", id="btn-view-middle", className="dvs-btn dvs-btn--sm", **{"aria-label": "显示中间N行数据"}),
                            html.Button("后 N 行", id="btn-view-tail", className="dvs-btn dvs-btn--sm", **{"aria-label": "显示后N行数据"}),
                            html.Button("全部数据", id="btn-view-all", className="dvs-btn dvs-btn--sm", **{"aria-label": "显示全部数据"}),
                        ],
                    ),
